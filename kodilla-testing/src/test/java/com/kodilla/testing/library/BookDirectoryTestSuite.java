...
class BookDirectoryTestSuite {
    ...
    void runBeforeEachTest(){
        this.bookLibrary = new BookLibrary(this.libraryDatabaseMock);
    }
    ...
    void testListBooksInHandsOfZeroBooks() {
        ...
        List<Book> booksInHandsOfZeroBooks = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(booksInHandsOfZeroBooks);
    ...
    void testListBooksInHandsOfOneBook() {
        // Given
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "123456789");
        List<Book> booksInHandsOfOneBook = new ArrayList<>();
        booksInHandsOfOneBook.add(new Book("Title", "Author", 2000));
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(booksInHandsOfOneBook);
    ...
    void testListBooksInHandsOfFiveBooks() {
        // Given
        LibraryUser libraryUser = new LibraryUser("John", "Doe", "123456789");
        List<Book> booksInHandsOfFiveBooks = new ArrayList<>();
        for (int i = 0; i < 5; i++) {
            booksInHandsOfFiveBooks.add(new Book("Title " + i, "Author " + i, 2000 + i));
        }
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser)).thenReturn(booksInHandsOfFiveBooks);
